...
enum ErrorMessages {
	PIN_REQUIRED = "FİN daxil edilməyib",
	FIRST_NAME_REQUIRED = "Ad daxil edilməyib",
	LAST_NAME_REQUIRED = "Soyad daxil edilməyib",
	FATHER_NAME_REQUIRED = "Ata adı daxil edilməyib",
	STRUCTURE_REQUIRED = "Təşkilat seçilməyib",
	STEPS_REQUIRED = "Təşkilatın rolu seçilməyib",
	ROLE_REQUIRED = "İstifadəçinin rolu seçilməyib",
...
export const validationSchema = Yup.object().shape({
	pin: Yup.string().required(ErrorMessages.PIN_REQUIRED),
	...
	fatherName: Yup.string().required(ErrorMessages.FATHER_NAME_REQUIRED),
